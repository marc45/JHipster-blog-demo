...
import com.hmcy.myapp.repository.CategoryRepository;
import com.hmcy.myapp.service.CategoryService;
...
public class CategoryResourceIntTest {
    ...
    private static final String DEFAULT_LINKY = "AAAAAAAAAA";
    private static final String UPDATED_LINKY = "BBBBBBBBBB";
    ...
    public void createCategory() throws Exception {
        ...
        assertThat(testCategory.getLinky()).isEqualTo(DEFAULT_LINKY);
    ...
    @Test
    @Transactional
    public void checkLinkyIsRequired() throws Exception {
        int databaseSizeBeforeTest = categoryRepository.findAll().size();
        // set the field null
        category.setLinky(null);
    ...
    public void getAllCategories() throws Exception {
        ...
        restCategoryMockMvc.perform(get("/api/categories?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].linky").value(hasItem(DEFAULT_LINKY.toString())))
    ...
    public void getCategory() throws Exception {
        ...
        restCategoryMockMvc.perform(get("/api/categories/{id}", category.getId()))
            ...
            .andExpect(jsonPath("$.linky").value(DEFAULT_LINKY.toString()))
    ...
    public void updateCategory() throws Exception {
        ...
        Category testCategory = categoryList.get(categoryList.size() - 1);
        assertThat(testCategory.getLinky()).isEqualTo(UPDATED_LINKY);
